...
import { FiEdit2, FiTrash2, FiMail, FiShield, FiUsers, FiLogIn } from "react-icons/fi";
...
const UserTable = ({ users, loading, handleDeleteUser, setOpenModal, setEditUser, handleImpersonate, isReadOnly }) => {
