...
const Dashboardmain = () => {
  ...
  return (
    <div className="space-y-4 pb-6 ">
      ...
      {(user?.role === "admin" || user?.role === "operationmanager") && (
        <div className="w-full theme-bg-card border theme-border rounded-xl p-4 shadow-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            <Link
              to={`/${user?.role}/projects`}
              className="flex items-center justify-between p-3.5 rounded-xl theme-bg-main hover:bg-slate-100/70 border theme-border transition-all group cursor-pointer"
            >
            ...
            >
              <div className="flex items-center gap-2.5 min-w-0">
                <span className="w-7 h-7 rounded-lg bg-purple-500/10 text-purple-500 flex items-center justify-center shrink-0">
                  <FiUser size={13} />
                </span>
                <span className="text-[11px] font-bold theme-text-primary truncate">
                  Team Chats & Rooms
