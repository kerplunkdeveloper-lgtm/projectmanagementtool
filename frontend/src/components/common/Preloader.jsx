    ...
    <div className="fixed inset-0 z-[99999] flex flex-col items-center justify-center bg-white dark:bg-[#020710] transition-colors duration-300">
      ...
      <div className="relative w-24 h-24 flex items-center justify-center mb-8">
        ...
        <div className="absolute flex items-center justify-center bg-[var(--accent-light-bg-subtle)] dark:bg-[var(--accent-dark-bg-subtle)] w-12 h-12 rounded-full shadow-lg shadow-[var(--accent-color)]/10 dark:shadow-[var(--accent-color-dark)]/10">
          <svg viewBox="0 0 24 24" className="w-6 h-6" style={{ color: 'var(--accent-color)' }} fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="flex flex-col items-center overflow-hidden">
        ...
        <div className="flex items-center gap-2 mt-3">
          <span className="w-1.5 h-1.5 rounded-full bg-[var(--accent-color)] animate-bounce" style={{ animationDelay: '0ms' }}></span>
          <span className="w-1.5 h-1.5 rounded-full bg-[var(--accent-color)] animate-bounce" style={{ animationDelay: '150ms' }}></span>
          <span className="w-1.5 h-1.5 rounded-full bg-[var(--accent-color)] animate-bounce" style={{ animationDelay: '300ms' }}></span>
        </div>
      </div>
