...
export const sidebarConfig = {
  admin: [
    ...
    { name: "SM Creditionals", path: "/admin/social-accounts", icon: FiKey, permissionKey: "manage_clients" },
  ...
  operationmanager: [
    ...
    { name: "SM Creditionals", path: "/operationmanager/social-accounts", icon: FiKey, permissionKey: "manage_clients" },
  ...
  team: [
    ...
    { name: "SM Creditionals", path: "/team/social-accounts", icon: FiKey, permissionKey: "manage_clients" },
